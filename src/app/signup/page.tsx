  ...
  return (
    <main className="min-h-screen bg-cosmic-950 px-4 text-cosmic-100">
      <div className="mx-auto max-w-md pt-20">
        <h1 className="glow-text-gold font-serif text-center text-3xl font-bold text-gold">Create Your Account</h1>
        <p className="mt-2 text-center text-cosmic-200/80">Join Cosmic Spirit Guide to save readings and unlock Premium.</p>

        <form onSubmit={handleSubmit} className="mt-8 rounded-2xl border border-gold/30 bg-cosmic-900/60 p-6 space-y-4">
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="block text-sm text-cosmic-300">First name</label>
            ...
            <div>
              <label className="block text-sm text-cosmic-300">Last name</label>
        ...
        <p className="mt-6 text-center text-sm text-cosmic-300">
          ...
          <a href="/login" className="text-gold underline-offset-4 hover:underline">Sign in</a>
        </p>
      </div>
    </main>
  );
