...
// F13-4: stepMinutes is mechanically derived from step ('1 h' -> 60, '1 d' -> 1440). The
// manifest no longer carries a redundant hand-written stepMinutes field.
export function deriveStepMinutes(step: '1 h' | '1 d'): number {
  return step === '1 h' ? 60 : 1440;
}
export const JPL_MANIFEST: JplManifestRow[] = [
  {
    ...
    target: 'Sun (10)', center: 'Earth (399)', start: '1990-06-15 09:00', stop: '1990-06-15 11:00',
        step: '1 h', expRows: 3, timeToken: '1990-Jun-15 10:00', expLon: 84.04995, lonDp: 5,
  },
  {
    ...
    target: 'Moon (301)', center: 'Earth (399)', start: '1990-06-15 09:00', stop: '1990-06-15 11:00',
        step: '1 h', expRows: 3, timeToken: '1990-Jun-15 10:00', expLon: 344.24579, lonDp: 5,
  },
  {
    ...
    target: 'Moon (301)', center: 'Earth (399)', start: '1990-06-15 21:00', stop: '1990-06-15 23:00',
        step: '1 h', expRows: 3, timeToken: '1990-Jun-15 22:00', expLon: 350.95686, lonDp: 5,
  },
  {
    ...
    target: 'Moon (301)', center: 'Earth (399)', start: '1990-06-16 20:59', stop: '1990-06-16 22:59',
        step: '1 h', expRows: 3, timeToken: '1990-Jun-16 21:59', expLon: 4.65108, lonDp: 5,
  },
  {
    ...
    target: 'Moon (301)', center: 'Earth (399)', start: '1990-06-10 21:00', stop: '1990-06-10 23:00',
        step: '1 h', expRows: 3, timeToken: '1990-Jun-10 22:00', expLon: 287.09834, lonDp: 5,
  },
  {
    ...
    target: 'Moon (301)', center: 'Earth (399)', start: '1990-06-11 20:59', stop: '1990-06-11 22:59',
        step: '1 h', expRows: 3, timeToken: '1990-Jun-11 21:59', expLon: 299.39723, lonDp: 5,
  },
  {
    ...
    target: 'Mercury (199)', center: 'Earth (399)', start: '1990-06-15 09:00', stop: '1990-06-15 11:00',
        step: '1 h', expRows: 3, timeToken: '1990-Jun-15 10:00', expLon: 65.54785, lonDp: 5,
  },
  {
    ...
    target: 'Venus (299)', center: 'Earth (399)', start: '1990-06-15 09:00', stop: '1990-06-15 11:00',
        step: '1 h', expRows: 3, timeToken: '1990-Jun-15 10:00', expLon: 48.67959, lonDp: 5,
  },
  {
    ...
    target: 'Mars (499)', center: 'Earth (399)', start: '1990-06-15 09:00', stop: '1990-06-15 11:00',
        step: '1 h', expRows: 3, timeToken: '1990-Jun-15 10:00', expLon: 10.98138, lonDp: 5,
  },
  {
    ...
    target: 'Jupiter (599)', center: 'Earth (399)', start: '1990-06-15 10:00', stop: '1990-06-16 10:00',
        step: '1 d', expRows: 2, timeToken: '1990-Jun-15 10:00', expLon: 105.87143, lonDp: 5,
  },
  {
    ...
    target: 'Saturn (699)', center: 'Earth (399)', start: '1990-06-15 10:00', stop: '1990-06-16 10:00',
        step: '1 d', expRows: 2, timeToken: '1990-Jun-15 10:00', expLon: 294.03681, lonDp: 5,
  },
  {
    ...
    target: 'Uranus (799)', center: 'Earth (399)', start: '1990-06-15 10:00', stop: '1990-06-16 10:00',
        step: '1 d', expRows: 2, timeToken: '1990-Jun-15 10:00', expLon: 278.16844, lonDp: 5,
  },
  {
    ...
    target: 'Neptune (899)', center: 'Earth (399)', start: '1990-06-15 10:00', stop: '1990-06-16 10:00',
        step: '1 d', expRows: 2, timeToken: '1990-Jun-15 10:00', expLon: 283.71915, lonDp: 5,
  },
  {
    ...
    target: 'Pluto (999)', center: 'Earth (399)', start: '1990-06-15 10:00', stop: '1990-06-16 10:00',
        step: '1 d', expRows: 2, timeToken: '1990-Jun-15 10:00', expLon: 225.40317, lonDp: 5,
  },
];
