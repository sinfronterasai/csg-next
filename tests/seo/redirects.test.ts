...
describe("validateManifest covers 301_EQUIVALENT (B8)", () => {
  it("passes a clean manifest with valid targets", () => {
    const rows = [
      row({ oldPath: "/blog/x", disposition: "301_EQUIVALENT", intendedStatus: 301, canonicalUrl: "https://cosmicspiritguide.com/tarot", redirectTarget: "https://cosmicspiritguide.com/tarot" }),
      row({ oldPath: "/old", disposition: "MERGE_AND_301", intendedStatus: 301, canonicalUrl: "https://cosmicspiritguide.com/new", redirectTarget: "https://cosmicspiritguide.com/new" }),
  ...
  it("flags a 301_EQUIVALENT whose target does not exist and has no manifest row", () => {
    const rows = [
      row({ oldPath: "/blog/unknown", disposition: "301_EQUIVALENT", intendedStatus: 301, canonicalUrl: "https://cosmicspiritguide.com/nowhere", redirectTarget: "https://cosmicspiritguide.com/nowhere" }),
    ];
  ...
  it("flags a 301_EQUIVALENT pointing at a non-200 route", () => {
    const rows = [
      row({ oldPath: "/from", disposition: "301_EQUIVALENT", intendedStatus: 301, canonicalUrl: "https://cosmicspiritguide.com/to410", redirectTarget: "https://cosmicspiritguide.com/to410" }),
  ...
  it("flags a self-loop 301_EQUIVALENT", () => {
    const rows = [
      row({ oldPath: "/loop", disposition: "301_EQUIVALENT", intendedStatus: 301, canonicalUrl: "https://cosmicspiritguide.com/loop", redirectTarget: "https://cosmicspiritguide.com/loop" }),
    ];
    const errs = validateManifestRows(rows, []);
